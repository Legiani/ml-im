!function(t) {
    ...
    t.fn.tagsInput = function(n) {
        const i = t.extend({
            ...
            a = new e,
            o = function(t) {
                return a.fillIn('<div class="tag {tagClass}"><span>{value}</span><input type="hidden" value="{label}" name="tags[]">{tagRemoveIcon}</div>', {
                    tagClass: a.sanitizeText(i.tagClass),
                    tagRemoveIcon: t ? "" : '<i class="tag-remove">&#10006;</i>'
                })
            };
        this.each(function() {
            ...
            const e = this.hasAttribute("disabled"),
                n = o(e),
                r = function(t) {
                    return a.fillIn('<div class="tags-container {tagsContainerClass} {state}"><input type="text" size="4" {state} value="" name="#tag"><div>', {
            ...
            l && t.each(l.split(";"), function(t, e) {
                const i = e.trim();
                i.length > 0 && c.unshift(jQuery(n.replace(/{label}|{value}/g, i)))
            });
            const u = t(r);
            t.each(c, function(t, e) {
                u.prepend(e)
            }), s.after(u), s.attr("hidden", "true"), s.attr("data-rendered", "true")
        }), t("i.tag-remove").click(a.removeTag), t(".tags-container").not("disabled").click(function(e) {
        ...
        t(".tags-container").not("disabled").children("input").keydown(function(e) {
            if ("Enter" === e.key || ";" === e.key) {
                ...
                if (o) {
                    ...
                    if (e.length > 0)
                        i.hasOwnProperty("tagColor") || (i.tagColor = e.css("background-color")), a.blink(e, i.highlightColor, i.tagColor);
                    else {
                        const e = t(r.replace(/{label}|{value}/g, o));
                        e.insertBefore(n), e.children("i").click(a.removeTag);
        ...
        const n = t(this),
            i = n.parent(),
            a = i.parent().prev(),
            o = n.siblings("span").text(),
            r = `(^${o};)|(;${o};)`,
            s = a.val().replace(new RegExp(r, "u"), ";");
        a.val(s), i.remove()
